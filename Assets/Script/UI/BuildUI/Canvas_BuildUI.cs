...
public partial class Canvas_UI :MonoBehaviour
{
	[SerializeField] private InputField                    InputField_InputField1;
	...
	private QInputField                                    qInputField_InputField1;
	...
	public Action<string>                                  onInputField_InputField1EndEdit;
	...
	public QInputField                                     QInputField_InputField1{get{return qInputField_InputField1;}}
	...
	private void Awake()
	{
		InputField_InputField1                             = transform.Find("InputField1").GetComponent<InputField>();
		Text_Placeholder                                   = transform.Find("InputField1/Placeholder").GetComponent<Text>();
		Text_Text                                          = transform.Find("InputField1/Text").GetComponent<Text>();
		...
		qInputField_InputField1                            = new QInputField(InputField_InputField1);
		...
		InputField_InputField1                             .onEndEdit.AddListener( OnInputField_InputField1EndEdit );
	...
	{
		if(onInputField_InputField1EndEdit!=null)onInputField_InputField1EndEdit(value);
	}
